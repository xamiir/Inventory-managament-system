        ...
        <div className="flex justify-center">
            <div className="w-full m-9 bg-white mt-10 p-6 rounded-lg">
                ...
                <div className="mb-4 flex justify-between  ">
                            ...
                            <input type="text" name="price" id="price" placeholder="Enter Price" className="bg-white border-2 w-[40%] p-2 rounded-lg flex justify-between" value={price} onChange={(e)=>setPrice(e.target.value)} />
                            </div>
                            <div className="mb-4 flex justify-between  ">
                            ...
                            <input type="text" name="quantity" id="quantity" placeholder="Enter Quantity" className="bg-white border-2 w-[40%] p-2 rounded-lg flex justify-between" value={quantity} onChange={(e)=>setQuantity(e.target.value)} />
                            </div>
                            <div className="mb-4 flex justify-between  ">
